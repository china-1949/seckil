...
import java.math.BigDecimal; //有小数点的价格
...
@Entity
	...
	private BigDecimal courcePrice; //课程价格
	...
	public String toString() {
		return "Course [courseNo=" + courseNo + ", courseName=" + courseName + ", teacherName=" + teacherName
				+ ", courseDesciption=" + courseDesciption + ", coursePeriod=" + coursePeriod + ", startTime="
				+ startTime + ", endTime=" + endTime + ", courcePrice=" + courcePrice + ", stockQuantity="
				+ stockQuantity + ", courseType=" + courseType + ", coursePic=" + coursePic + "]";
	}
